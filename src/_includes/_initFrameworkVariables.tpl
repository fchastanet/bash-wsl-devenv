...
BASH_DEV_ENV_ROOT_DIR="$(cd "${CURRENT_DIR}/<% ${RELATIVE_FRAMEWORK_DIR_TO_CURRENT_DIR} %>" && pwd -P)"
if [[ -d "${BASH_DEV_ENV_ROOT_DIR}/vendor/bash-tools-framework/" ]]; then
  FRAMEWORK_ROOT_DIR="$(cd "${BASH_DEV_ENV_ROOT_DIR}/vendor/bash-tools-framework" && pwd -P)"
else
